...
function game(arr) {
    ...
    while (!checkedLines.includes(key)) {
        if (instObj[`${key}`]['op'] === 'acc') {
            accum += instObj[`${key}`]['arg']
            checkedLines.push(key)
            key++
        }
        if (instObj[`${key}`]['op'] === 'jmp') {
            checkedLines.push(key)
            key += instObj[`${key}`]['arg']
        }
        if (instObj[`${key}`]['op'] === 'nop') {
            checkedLines.push(key)
            key++
        }
        // console.log('key', key)
        // console.log('accum', accum)
        // console.log('checkedlines', checkedLines)
    }
